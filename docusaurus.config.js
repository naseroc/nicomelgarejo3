...
const config = {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      { property: 'og:description', content: 'Explora recursos educativos innovadores para la preparación PAES M1 y M2. Libros, ejercicios y más para potenciar tu aprendizaje.' },
      { property: 'og:image', content: 'https://files.nicomelgarejo.com/nm-cuadrado.png' },
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'TikTok',
              href: 'https://www.tiktok.com/@nicomelgarejo_com',
            },
          ],
        },
        {
